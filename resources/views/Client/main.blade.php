	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url({{$sliders->image}});">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="client-main" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{asset('')}}template/images/banner-clb-2021-910x500.jpg" alt="IMG-BANNER" height= "270px">

						<a href="Category/3do-bo.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{asset('')}}template/images/banner-quang-cao-thoi-trang-nam-dep_113855444.jpg" alt="IMG-BANNER" height= "270px">

						<a href="/Category/2quan.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
								New men's pants
								</span>
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{asset('')}}template/images/banner-thoi-trang-nam (2).jpg" alt="IMG-BANNER" height= "270px">

						<a href="/Category/1ao.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
								New men's shirt
								</span>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --><footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
